...
/**
 * The original fabricated placeholder data v0 generated for this site,
 * kept around for testing (filters, layouts, card variants) against a
 * larger dataset. Not imported by any page — the live site reads WORK
 * from ./work instead.
 */

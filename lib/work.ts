...
const REAL_WORK: WorkItem[] = [
  ...
  },
  {
    ...
    year: '2024',
    description: 'A month of watercolor prompts, one a day, prompt list by @faunwood — 29 of 30 days. The export this came from seems to cut off right after day 29, so day 30 is a placeholder until it turns up.',
    tags: ['art', 'watercolor'],
